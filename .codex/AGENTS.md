...
- Treat `docs/design-system/design-sheet.html` and `docs/design-system/design-sheet.md` as the persistent visual reference.
- Keep commits small and focused so major UI/system steps remain recoverable.
- Preserve the current TacitSNS workshop demo as the baseline until an explicit design cleanup replaces parts of it.
